    ...
    children: (
      <div>
        <ul>
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Modern Technologies and the evolution of PHP  </li>
          <li className="mb-2">
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Web application architecture</li>
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> What is WWW ?</li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />What is HTTP ? </li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> What is URL ?</li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />What is W3C ? </li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />What is DNS ? </li>
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> WBasic knowledge of Web designing & Layouts, Color Schemes, Fonts, Responsive designs
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> What is HTML & CSS?
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> What are web pages ? </li>

            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Absolute vs. Relative URL </li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Static Vs Dynamic Websites </li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Client side Vs Server side Scripting </li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  How web works ?</li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />The term ” REQUEST & RESPONSE “ </li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Databases Basics </li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> SEO basics </li>
        </ul>
      </div>
    ),
  },
...

  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Jquery basics and syntax
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Jquery DOM, Selectors, Attributes – BASICS
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
            AJAX – BASICS
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Get started
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Basic Component</li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Bootstrap components
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
            Plugins
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Angular JS vs Latest Angula
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />JWeb Components
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "} JavaScript and its Issues </li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "} What is TypeScript </li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}  TypeScript vs JavaScript vs ES6</li>
            <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "} Benefits of TypeScript  </li>
        </ul>
      </div>
    ),
  },
...
const items2 = [
  {
    key: "1",
    label:
      "Can I do the UI training in my spare time?",
    children: (
      <div>
  ...
  {
    key: "2",
    label: "Do you specifically look for any qualifications to join the UI training?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
  ...
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        KITKAT Software Academy offers you the most updated, relevant and high value real-time projects as part of the training program
        </div>
      </div>
    ),
  },
  ...
  {
    key: "6",
    label: "What can I expect to accomplish by the end of the web designing course?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
  ...
  return (
    <div>
      ...
      <div className="section3">
        ...
        <div className="container m-auto p-6">
          ...
          KITKAT Software Technologics offers an exceptional{" "}
            ...
            Our program covers everything you need to know about UI Design, including HTML, CSS, Javascript, and Jquery. We also provide training in PHP development for the web, giving you the skills you need to create functional and visually appealing websites. Plus, our course includes training in MYSQL database, essential for e-commerce. Join us at NSCHOOL Academy and get ready for a successful career in web design with our 

            <span className="font-semibold">
            100% placement guarantee in Coimbatore.
            </span>{" "}
             Students will learn how to connect to databases, create database-driven HTML forms and reports, and implement e-commerce skills such as user authentication and shopping cart implementation. The course also covers configuring PHP and the Apache Web Server. Throughout the program, students will gain hands-on experience by working on real-time projects to reinforce their learning and develop real competency. Our ultimate goal is to help students secure placements in software companies and obtain certification in web design upon completion of the course. Join our
            ...
            <Row gutter={32} style={{ margin: 0 }}>
              ...
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  You will be learning the basics and programming in HTML, CSS, and Javascript(JS).               </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
              ...
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Our web desining training in Coimbatore will impart your knowledge on the usage of API web services
                </div>
              </Col>
            </Row>
          </div>
      ...
      <div className="section4 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          Best Web Designing Certification course in coimbatore 
            ...
            is designed to give you an essence of User Interface and web page styling technologies. You will learn to design a web page with scripting languages like HTML, CSS, and Javascript(JS)
          </div>
        </div>
      </div>
        ...
        <div className="container m-auto">
          <Row gutter={16} style={{ margin: 0 }} className="items-center">
            ...
            <Col lg={12} md={12} sm={24}>
              <div>
                <div className="text-base">
                UI/web designing training is essential in the field of software web application development. The user interface (UI) is the first point of interaction for users when they open a webpage, and it plays a crucial role in their overall experience. UI designing involves a combination of HTML, CSS, JavaScript, jQuery, Angular, XML parsing, JSON parsing, and API web services. By learning these skills, tools, and processes, you can become a proficient UI designer. With the increasing demand for web-based applications and the growing use of web technology across various devices, UI development has become a highly sought-after skill. NSCHOOL Academy, the
                <span className="font-semibold">
                top web design training institute in Coimbatore,
            </span>{" "}
            offers comprehensive UI development training both online and in classrooms. Our expert trainers, with over 10 years of industrial experience, provide practical training to equip you with the necessary skills for a successful career in UI/web designing.
                </div>
                <div className="mt-8">
      ...
      <div className="section7 bg-[#49adcc4a]">
        <div className="container m-auto p-6">
          <div className="text-center text-3xl font-semibold mt-4 mb-8">
          Why KITKAT Software Technologics for WEB DESIGNING TRAINING IN COIMBATORE?
          </div>
          <div className="text-base pb-4">
            
            KITKAT Software Technologics UI/Web Designing program provides extensive hands-on training in front-end, middleware, and back-end technology skills along with phase-end and capstone projects based on real business scenarios
          </div>
          <div className="mt-6">

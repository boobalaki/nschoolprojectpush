...
const items = [
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Introduction to Big Data
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Big Data Analytics
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Big data: definition and taxonomy 
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Apache Hadoop

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Analysing Data with Unix tools

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Analysing Data with Hadoop
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Hadoop Streaming
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> IBM Big Data Strategy
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />   The Design of HDFS & Concepts
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Data Ingest with Flume, Scoop, Hadoop archives
        </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Hadoop I/O: Compression, Serialization
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Introduction to Hadoop
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Loading data into Hadoop
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Handling files in Hadoop
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Introduction to the SQL Language
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
            From SQL to HiveQL
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Introduction to HIVE e HIVEQL
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Using Hive to query Hadoop files
          </li>      
        </ul>
      </div>
    ),
...

  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Quick intro to Machine learning

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
            Big Data & Machine Learning          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Machine learning tools

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Spark SparkML Azure ML
          </li>
        </ul>
      </div>
    ),
...
const items2 = [
  {
    ...
    children: (
      <div>
        ...
        Our Trainers are chosen not only for their knowledge and expertise but also for their real-world experience in the field they teach. They will help you Get Resume Ready and provide with mock Interview practices too
</div>
  </div>
    ),
  },
  ...
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        Sure, We provide this course online as well for those who can not attend this course in the classroom
  ...
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        We accept all major kinds of payment options. Cash, Card and Net Banking and etc
          ...
          <Row gutter={32} style={{ margin: 0 }} className="items-center">
            <Col lg={12} md={12} sm={24}>
              <div>
                ...
                Power your career with great Big Data learning and specialize on HDFS, Map Reduce, Oozie and Flume and many more.
                </div>
            ...
            <Row gutter={32} style={{ margin: 0 }}>
              ...
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Appreciate the need for a platform like Hadoop.                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
                  ...
                  Overview of the technological landscape of Big Data.                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
        ...
        <div className="container m-auto p-6">
          ...
          KITKAT SOFTWARE ACADEMY{" "}
            ...
            Big Data Developer
             ...
             program provides extensive hands-on training in front-end, and back-end technology skills along with phase-end and capstone projects based on real business scenarios          </div>
          <div className="mt-6">

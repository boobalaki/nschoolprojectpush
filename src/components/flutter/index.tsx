...
const items = [
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Introduction to Flutter
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Set up an environment for development
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Why do we need to use Flutter?
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> About Dart?
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> An Overview of Flutter Architecture
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> how to build a Flutter app
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Assets in Flutter?
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Flutter’s Reactive Framework
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Flutter Dev Tools
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Container widgets
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Layout column, row widgets ,icon widget
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Customize widget & stateful widgets?
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />State, List
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Navigation & Routing
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />User Inputs and Forms
          </li>
          <li className="mb-2">
  ...
  
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Creating a Flutter App
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Material Design Basics – Text and Widget Properties
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Material Design Presentation

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Flutter Scaffold Widget and Properties
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Flutter InkWell Widget and Event Listeners
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Flutter Gesture Detector Widget
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Flutter Bottom Navigator and Adding a Tap
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Flutter Floating Action Button
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Tab Layouts, Fragments
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Data Modelling & handle permissions
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Access storage devices
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Map – real time location
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Accessing local services
          </li>
          </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> introduction to packages?

          </li>  
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> JSON & JSON Parsing

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Database concepts
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Accessing REST API
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Hot reload & Debugging Tools
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Testing and debug app?
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Inspecting UI?
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Build and release for Android/iOS apps

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Deploy on the app store
          </li>
        </ul>
      </div>
    ),
...
const items2 = [
  {
    key: "",
    label: "Is there any prerequisite to join the flutter course in this flutter app development institute?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        Coding knowledge in C and C++ and learning interest in Dart programming adds more potential to learn the Flutter courses
        </div>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        Yes, Definitely! KITKAT SOFTWARE Academy with pleasure arranges for free demo class as per your convenient timings thrice
        </div>
      </div>
    ),
  },
    ...
    <div>
          ...
          <Row gutter={32} style={{ margin: 0 }} className="items-center">
            <Col lg={12} md={12} sm={24}>
              <div>
                ...
                Explore the core features of Flutter in developing Dart programming
                </div>
      ...
      <div className="section3">
        ...
        <div className="container m-auto p-6">
          ...
          Flutter is actually a Software development kit(SDK) created by Google. This Google Product is used to develop applications for operating systems like Android, iOS, Linux, Mac, Windows, and Google Fuchsia. This Flutter is hence an application framework model that is originally written in Dart programming language. The first version of Flutter is named Sky that ran in the Android operating system.Best Flutter App Development Course in Coimbatore are the top preferred by professional developers right now. The reason is because of its stability and readability of its components. Flutter based mobile applications are stylish and highly interactive and choose the right Flutter course in Coimbatore covering its trends and versions. Our NSCHOOL Academy is a leader in training Android and IOS apps to freshers and hence advanced Flutter training in Coimbatore is given as hands-on training to trainees. Understanding the importance and job nature of Flutter developers, we offer the best Flutter course in coimbatore to the student community and foresee them as actual Flutter developers.
          </div>
            ...
            <Row gutter={32} style={{ margin: 0 }}>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  You will be learning the functionalities of C and C++ Programming and Dart coding and its features in our Best Flutter Training Institute in Coimbatore.                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
                  ...
                  Flutter advanced course training in Coimbatore will facilitate how to work in the Dart platform and App Flutter Engine.
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  You will learn the development of Dart Widgets (Flutter application framework) by exploring Flutter and Dart Training Course in Coimbatore.
              ...
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Get through this trusted and branded Google product and develop attractive and lively mobile and web apps with quality results.                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
                  ...
                  Traverse through the Flutter Application features like Widgets and Internationalized Flutter libraries                </div>
              </Col>
            </Row>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="mt-8">
                  <div className="text-base mb-2">
                    <div>Flutter is free, and open-source Software Development Kit(SDK) used to develop high performing Android and iOS applications development with the single code base. It is a dynamic, cross-platform framework, launched by Google in 2018 with all the integrated widgets and tools that result in faster app development. Flutter is empowered with a layered structure, so developers can build highly customized and attractive app solutions in less time without compromising with the performance. Also, making changes in the Flutter codebase is quite more comfortable and quicker as it owns a hot reload feature which reflects instant changes in the codebase within milliseconds</div>
                    <span className="font-semibold">
                      <ArrowRightOutlined className="bg-black text-white p-1 rounded-2xl text-xs" />
                    </span>{" "}
      ...
      <div className="section7 bg-[#49adcc4a]">
        <div className="container m-auto p-6">
          ...
          <div>
          As our KITKAT SOFTWARE Technology is a Mobile App Development specialized training institute in Coimbatore, you can effectively gain Dart programming knowledge by enrolling in our Google Flutter full course. Get exposed to Android and IOS app development practically at NSCHOOL Academy and kick-start your career as Mobile App Developer.
      ...
      <div className="section9 bg-[#1b424e] pt-8">
        <div className="container mx-auto md:px-6 xl:px-24">
          <section>
            ...
            FLUTTER APP DEVELOPMENT COURSE HIGHLIGHTS            </h2>
            <div className="mb-6 pl-6 pr-6 text-base text-white">
            Flutter app development and its training courses are the top preferred by professional developers right now. The reason is because of its stability and readability of its components. Flutter based mobile applications are stylish and highly interactive and choose the right Flutter training courses covering its trends and versions.

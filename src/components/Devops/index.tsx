...
const items = [
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />What Is DevOps ?
</li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Core Concepts of  DevOps
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> DevOps Main Objectives
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> DevOps and Software Development Life Cycle
          </li>
          <li>Waterfall</li>
          <li>Agile</li>
        </ul>
...

  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> GIT Features
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
            3-Tree Architecture
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />   GIT – Clone /Commit / Push
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />GIT Hub Projects
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> GIT Hub Management
          </li>  
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> GIT Rebase & Merge
        
          </li>   
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> GIT Stash, Reset, Checkout
          </li>   
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />GIT Clone, Fetch, Pull
          </li>    
        </ul>
      </div>
    ),
...

  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  What is Cloud?
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> IAAS (Infrastructure as a Service)

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />SAAS (Software as a Service)
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
...

  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Introduction to Jenkins
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Scheduling build Jobs
          </li>
          <li>POLL SCM</li>
          <li>
Build Periodically</li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Maven Build Scripts
          </li> 
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Support for the GIT version control System
          </li> 
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Different types of Jenkins Jobs 
          </li> 
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Jenkins Build Pipe Line
          </li> 
          <li>Parent and Child Builds   </li>
          <li>Sequential Builds</li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Jenkins Master & Slave Node Configuration        
          </li> 
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Jenkins Workspace Management     
          </li> 
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Securing Jenkins
          </li> 
          <li>Authentication Authorization</li>
          <li>
Confidentiality Creating Users</li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Jenkins Plugins
          </li> 
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Introduction to  Docker Image
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Docker Containers

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Docker Command Line Interphase
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Docker Compose
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Docker Hub, Swarm
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Docker Trusted Registry 
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Docker attach
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Docker File & Commands
          </li>
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Introduction to Ansible
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Infrastructure Management 

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />SSH Connection in Ansible Master
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />YAML Scripts
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Host Inventory
          </li>
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Ad-hoc Commands

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Playbooks
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Modules – Core & Extra Modules

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Ansible Roles
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Linux OS Introduction
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Linux Basic Command Utilities
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Linux Administration
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Environment Variables &Networking
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Linux Server Installation
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  RPM and YUM Installation
          </li>
    ...
    children: (
      <div>
        <ul>
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Variables, Flow Controls, Loops
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Functions, Lists
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Manipulating Strings
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Reading and Writing Files
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Positional Parameters
          </li>
           </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Maven Installation & Build requirements
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />   Maven POM Builds (pom.xml)
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Maven Build Life Cycle
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Maven Local Repository (.m2)
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Maven Global Repository
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Group ID, Artifact ID, Snapshot
          </li>
           </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Introduction to Selenium
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Selenium – Webdriver Preview

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Creating Test Cases in Selenium WebDriver (Waits)
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> What and why X-Path
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Handling different controls on Webpage
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Framework in Selenium
          </li>
           </ul>
      </div>
    ),
...
const items2 = [
  {
    ...
    children: (
      <div>
        ...
        Yes, We do provide Placement Support. We have a Dedicated placement Officer taking care of the Students placement. Over and above we have tie-ups with so many IT Companies where the prospective HRs and Employers contact us for placements & internships
  ...
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        Our Trainers are chosen not only for their knowledge and expertise but also for their real-world experience in the field they teach. We Will Help you Get Resume Ready and with Provided Interview
  ...
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        The entire DevOps training has been built around Real Time Implementation, You Get Hands-on Experience with Industry Projects which will help you to Build your Project Portfolio
    ...
    <div>
          ...
          <Row gutter={32} style={{ margin: 0 }} className="items-center">
            <Col lg={12} md={12} sm={24}>
              <div>
                ...
                Power your career with great DevOps learning and specialize on its Configuration Management & Continuation Integration tools like Jenkins, Git, Docker, Chef and many more
      ...
      <div className="section3">
        ...
        <div className="container m-auto p-6">
          ...
          {" "}
            ...
            DevOps was first called Agile operations or Agile System Administration. It is all the more a culture that incorporates rehearses that bring the turn of development and task groups in an organization together. DevOps assists with expanding the general norm and to represent a mind the number of interferences. Some other prominent favorable advantages that tag along while utilizing DevOps are decreased time range to beat disappointment, diminished deployment rollbacks, decreased advancement cycle, and improved delivery speed. The DevOps Training Institute in Coimbatore furnished by NSCHOOL Academy accompanies the guarantee of 100% situations and excellent industry presentation. The DevOps accreditation is likewise an aspect of the DevOps preparation and is extremely useful for all the students in getting their fantasy occupations and for understanding their expert objectives.NSCHOOL Academy, one of the best DevOps training institutes in Coimbatore will assist you with getting completely capable in DevOps development and send DevOps principles and tools in a software enterprise. You will master procedures for incorporating IT development and activities teams. This DevOps course in Coimbatore will assist you with seeing how to convey, team up, and robotize key processes and frameworks so as to make collaborations for making quicker and better programming solutions.
            ...
            <Row gutter={32} style={{ margin: 0 }}>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Understanding the concept of DevOps and the need for DevOps.</div>              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
                    <ArrowRightOutlined className="bg-black text-white p-1 rounded-2xl text-xs" />{" "}
              ...
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Implementing Continuous Integration (CI) with Jenkins.</div>              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
                    <ArrowRightOutlined className="bg-black text-white p-1 rounded-2xl text-xs" />{" "}
                  ...
                  Implementing Infrastructure Monitoring with Nagios.              </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
                ...
                <div className="text-base">
                  ...
                  Getting hands-on practice on all the major components covered in this course.                  </div>
                  </Col>              
            </Row>
          </div>
        </div>
      ...
      <div className="section4 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          This DevOps Development Certification course is designed to give you an essence of the basic concept and you’ll learn more about Continuous Integration, Configuration Management. This hands-on session will gain you continuous improvement on your performance
        ...
        <div className="container m-auto">
          <Row gutter={16} style={{ margin: 0 }} className="items-center">
            ...
            <Col lg={12} md={12} sm={24}>
              <div>
                <div className="text-base">
                The normal salary of a DevOps Development Engineer in India is gradually increasing. You are in demand, you can keep on working in India, or seek after work abroad, DevOps aptitudes will be high on the rundown of needs for associations. The compensation is generally excellent and Earning openings are unending a direct result of the interest and requirement for good and gifted DevOps Engineers. When we have built up your DevOps abilities, you can fuse the prescribed procedures in Continuous Development, Continuous Testing, Continuous Integration, Continuous Software Monitoring, and Configuration Management.Icon awesome arrow circle right   Train from professionals with industry experience
                ...
                <div className="mt-8">
                  <div className="text-base mb-2">
                    ...
                    Learn theoretical concepts and gain hands-on training simultaneously                  </div>
                  <div className="text-base mb-2">
                    <span className="font-semibold">
                      <ArrowRightOutlined className="bg-black text-white p-1 rounded-2xl text-xs" />
                    </span>{" "}
                    Real time Hands-On Practical Experience Training to imbibe corporate practicesy
                  </div>
                  <div className="text-base mb-2">
                    <span className="font-semibold">
                      <ArrowRightOutlined className="bg-black text-white p-1 rounded-2xl text-xs" />
        ...
        <div className="container m-auto p-6">
          ...
          <div className="text-base pb-4">
           {" "}
            ...
            DevOps Development program provides extensive hands-on training in front-end, middleware, and back-end technology skills along with phase-end and capstone projects based on real business scenarios</div>         
      ...
      <div className="section8 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          <div className="text-base text-center pb-4">
          Learners taking this DevOps course in Coimbatore are expected to have an understanding of Linux fundamentals, Web Development fundamentals, and Java fundamentals
.
          </div>
        </div>
      </div>
...
export default Dev_opsComponent;
